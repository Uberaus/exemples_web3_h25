...
using fichier_api.Services;
using Microsoft.AspNetCore.Http.Features;

const long tailleMaximaleFichier = 5 * 1024 * 1024; // 5 Mo = 5 * 1024 Ko = 5 * 1024 * 1024 octets
Fichier.CreerDossierTeleversements(); // Crée le dossier de téléversements s'il n'existe pas

var builder = WebApplication.CreateBuilder(args);

builder.Services.Configure<FormOptions>(options =>
{
    options.MultipartBodyLengthLimit = tailleMaximaleFichier;
});
